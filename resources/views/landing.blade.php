...
>>>>>>> c670508da0ff02ddfe4dc9256d2671a1f7ec4a8d
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 items-start">
                @foreach($packages as $package)
                    <div class="reveal card-modern rounded-[2rem] p-6 group flex flex-col h-full relative hover:border-gold-500/50 transition-all duration-300 {{ $package->is_featured ? 'bg-gold-500/5 border-gold-500/30' : '' }}">
                        ...
                        <a href="https://wa.me/{{ $settings['whatsapp_number'] }}" target="_blank" class="block w-full text-center py-3 rounded-xl font-bold transition-all {{ $package->is_featured ? 'bg-gold-500 text-black' : 'border border-white/20 text-white hover:bg-white hover:text-black' }}">Pilih Paket</a>
                    </div>
                @endforeach
            </div>
        </div>
            ...
            <div class="bg-dark-surface border border-white/10 rounded-[3rem] p-10 md:p-16 relative overflow-hidden shadow-2xl">
                ...
                <div class="relative z-10 text-center">
                    ...
                    <div class="flex flex-col sm:flex-row justify-center gap-4">
                        <a href="https://wa.me/{{ $settings['whatsapp_number'] }}" target="_blank" class="px-10 py-4 bg-gold-500 text-black rounded-2xl font-bold shadow-lg hover:-translate-y-1 transition text-center">Mulai Sekarang</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <a href="https://wa.me/{{ $settings['whatsapp_number'] }}" target="_blank" class="fixed bottom-6 right-6 z-[60] bg-[#25D366] p-4 rounded-full shadow-[0_0_30px_rgba(37,211,102,0.4)] hover:scale-110 active:scale-95 transition-all group border border-white/10">
