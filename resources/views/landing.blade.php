...
<head>
    ...
    <title>HyperLink - Next Gen Internet</title>
    ...
    <header class="relative pt-40 pb-20 px-6 min-h-screen flex flex-col items-center justify-center text-center overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto reveal active">
            ...
            <h1 class="font-display text-5xl md:text-8xl font-bold text-white leading-[1.1] mb-6 tracking-tight">
                Connecting Your <br>
                <span class="text-gold-gradient drop-shadow-[0_0_20px_rgba(234,179,8,0.3)]">Happiness.</span>
            </h1>

            <p class="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed">
                Nikmati koneksi fiber optik super cepat hingga <strong class="text-white">10 Gbps</strong> dengan latency ultra rendah. Sempurna untuk gaming, streaming, dan WFH.
            </p>
            ...
            <div class="grid grid-cols-3 gap-4 md:gap-12 bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-6 md:p-8 shadow-2xl max-w-3xl mx-auto">
                <div>
                    <p class="text-3xl md:text-4xl font-display font-bold text-white">10 Gbps</p>
                    <p class="text-xs text-gray-400 font-bold uppercase tracking-wider mt-1">Kecepatan</p>
                </div>
                <div class="border-l border-white/10">
                    <p class="text-3xl md:text-4xl font-display font-bold text-gold-400">&lt; 1 ms</p>
                    <p class="text-xs text-gray-400 font-bold uppercase tracking-wider mt-1">Latency</p>
                </div>
                <div class="border-l border-white/10">
                    <p class="text-3xl md:text-4xl font-display font-bold text-white">50K+</p>
                    <p class="text-xs text-gray-400 font-bold uppercase tracking-wider mt-1">Pelanggan</p>
                </div>
            </div>
        </div>
    </header>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[250px]">
                ...
                <div class="reveal md:col-span-2 card-modern rounded-[2rem] p-8 relative overflow-hidden group flex flex-col justify-between">
                    ...
                    <div class="flex items-end gap-2 h-16 mt-4 opacity-50">
                        ...
                        <div class="w-full bg-gold-500 h-[50%] rounded-t-sm animate-pulse animation-delay-100"></div>
                ...
                <div class="reveal card-modern rounded-[2rem] p-8 group hover:bg-gold-500/5 transition">
                    ...
                    <h3 class="font-display text-xl font-bold mb-2 text-white">Latency Rendah</h3>
                    <p class="text-gray-400 text-sm">Ping sub-milidetik, ideal untuk gaming kompetitif.</p>
                </div>
